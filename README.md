...
It's made with Angular (currently version 22, started at version 16) with standalone components. The data are managed by a own service and the graphs are generated with SVG graphics, no libraries used.
